...
struct qt_meta_stringdata_captchaWindowClass_t {
    QByteArrayData data[6];
    char stringdata0[75];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_captchaWindowClass_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_captchaWindowClass_t qt_meta_stringdata_captchaWindowClass = {
    {
QT_MOC_LITERAL(0, 0, 18), // "captchaWindowClass"
QT_MOC_LITERAL(1, 19, 14), // "codeForCaptcha"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 11), // "captchaCode"
QT_MOC_LITERAL(4, 47, 11), // "showCaptcha"
QT_MOC_LITERAL(5, 59, 15) // "sendCaptchaCode"

    },
    "captchaWindowClass\0codeForCaptcha\0\0"
    "captchaCode\0showCaptcha\0sendCaptchaCode"
};
...
void captchaWindowClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (captchaWindowClass::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&captchaWindowClass::codeForCaptcha)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject captchaWindowClass::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_captchaWindowClass.data,
      qt_meta_data_captchaWindowClass,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *captchaWindowClass::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_captchaWindowClass.stringdata0))
