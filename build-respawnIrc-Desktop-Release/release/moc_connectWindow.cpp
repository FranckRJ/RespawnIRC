...
static const char qt_meta_stringdata_connectWindowClass[] = {
    "connectWindowClass\0\0"
    "newCookiek,newPseudoOfUser,saveInfo\0"
    "newCookiesAvailable(QList<QNetworkCookie>,QString,bool)\0"
...
const QMetaObjectExtraData connectWindowClass::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject connectWindowClass::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_connectWindowClass,
      qt_meta_data_connectWindowClass, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &connectWindowClass::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_connectWindowClass))
