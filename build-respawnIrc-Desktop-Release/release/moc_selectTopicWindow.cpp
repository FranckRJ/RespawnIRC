...
static const char qt_meta_stringdata_selectTopicWindow[] = {
    "selectTopicWindow\0\0newTopic\0"
    "newTopicSelected(QString)\0selectThisTopic()\0"
};
...
const QMetaObjectExtraData selectTopicWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject selectTopicWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_selectTopicWindow,
      qt_meta_data_selectTopicWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &selectTopicWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_selectTopicWindow))
