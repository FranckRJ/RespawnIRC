...
static const uint qt_meta_data_showTopicMessagesClass[] = {
 ...
 // signals: name, argc, parameters, tag, flags
      ...
      11,    5,  142,    2, 0x06 /* Public */,
      15,    0,  153,    2, 0x06 /* Public */,
      16,    1,  154,    2, 0x06 /* Public */,
      18,    1,  157,    2, 0x06 /* Public */,
      20,    1,  160,    2, 0x06 /* Public */,
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      27,    1,  177,    2, 0x2a /* Public | MethodCloned */,
      27,    0,  180,    2, 0x2a /* Public | MethodCloned */,
 ...
 // signals: parameters
    ...
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, QMetaType::Int, QMetaType::QString, QMetaType::QString, QMetaType::QString, QMetaType::Bool,    7,   12,   13,   14,    8,
    QMetaType::Void,
 ...
 // slots: parameters
    ...
    QMetaType::Bool, QMetaType::Int, QMetaType::Bool,   28,    8,
...
void showTopicMessagesClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->topicNeedChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 9: _t->openThisTopicInNewTab((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 10: _t->setNewTheme((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 11: _t->setNewTopic((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 12: _t->linkClicked((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        case 13: { bool _r = _t->getEditInfo((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 14: { bool _r = _t->getEditInfo((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 15: { bool _r = _t->getEditInfo();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 16: _t->getQuoteInfo((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 17: _t->getMessages(); break;
        case 18: _t->loadFirstPageFinish(); break;
        case 19: _t->loadSecondPageFinish(); break;
        case 20: _t->analyzeEditInfo(); break;
        case 21: _t->analyzeQuoteInfo(); break;
        case 22: _t->analyzeMessages(); break;
        default: ;
        }
        ...
        {
            typedef void (showTopicMessagesClass::*_t)(int , bool );
        ...
        {
            typedef void (showTopicMessagesClass::*_t)(int , QString , QString , QString , bool );
        ...
        {
            typedef void (showTopicMessagesClass::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&showTopicMessagesClass::topicNeedChanged)) {
                *result = 8;
            }
        }
        {
            typedef void (showTopicMessagesClass::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&showTopicMessagesClass::openThisTopicInNewTab)) {
                *result = 9;
            }
        }
    }
...
// SIGNAL 2
void showTopicMessagesClass::editThisMessage(int _t1, bool _t2)
{
...
// SIGNAL 5
void showTopicMessagesClass::setEditInfo(int _t1, QString _t2, QString _t3, QString _t4, bool _t5)
{
...
// SIGNAL 8
void showTopicMessagesClass::topicNeedChanged(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 9
void showTopicMessagesClass::openThisTopicInNewTab(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
