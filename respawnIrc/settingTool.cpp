...
void settingTool::initializeDefaultListsOption()
{
    ...
    listOfDefaultIntOption["updateTopicTime"].value = 10'000;
    listOfDefaultIntOption["updateTopicTime"].minValue = 2'000;
    listOfDefaultIntOption["updateTopicTime"].maxValue = 60'000;
    ...
    listOfDefaultIntOption["stickersSize"].maxValue = 1'000;
    ...
    listOfDefaultIntOption["noelshackImageWidth"].maxValue = 1'000;
    ...
    listOfDefaultIntOption["updateTopicListTime"].value = 20'000;
    listOfDefaultIntOption["updateTopicListTime"].minValue = 5'000;
    listOfDefaultIntOption["updateTopicListTime"].maxValue = 60'000;
