...
QString styleTool::getModel(QString themeName)
{
    ...
    {
        return "<table><tr><td><%BUTTON_QUOTE%><%BUTTON_BLACKLIST%><%BUTTON_EDIT%><%BUTTON_DELETE%>[<a style=\"color: <%DATE_COLOR%>;text-decoration: none\" href=\"https://www.jeuxvideo.com/"
                "<%PSEUDO_LOWER%>/forums/message/<%ID_MESSAGE%>\"><%DATE_MESSAGE%></a>] &lt;<a href=\"https://www.jeuxvideo.com/profil/"
