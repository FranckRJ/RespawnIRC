...
mainWindowClass::mainWindowClass() : respawnIrc(this)
{
    ...
    menuSetting->addSeparator();
    QAction* actionShowQuoteButtons = menuSetting->addAction("Ajouter un bouton pour citer un message");
    QAction* actionShowBlacklistButtons = menuSetting->addAction("Ajouter un bouton pour ignorer un pseudo");
    QAction* actionShowEditButtons = menuSetting->addAction("Ajouter un bouton pour éditer un message");
    menuSetting->addSeparator();
    ...
    actionShowQuoteButtons->setCheckable(true);
    actionShowQuoteButtons->setChecked(settingToolClass::getShowQuoteButton());
    actionShowBlacklistButtons->setCheckable(true);
    actionShowBlacklistButtons->setChecked(settingToolClass::getShowBlacklistButton());
    actionShowEditButtons->setCheckable(true);
    actionShowEditButtons->setChecked(settingToolClass::getShowEditButton());
