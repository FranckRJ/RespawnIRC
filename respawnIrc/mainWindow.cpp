...
mainWindowClass::mainWindowClass() : respawnIrc(this)
{
    ...
    settingToolClass::createActionForOption("Temps en secondes avant le timeout des requêtes", "timeoutInSecond", menuSetting, &respawnIrc, SLOT(showSelectIntWindow()), false);
    settingToolClass::createActionForOption("Taux de rafraichissement des topics", "updateTopicTime", menuSetting, &respawnIrc, SLOT(showSelectIntWindow()), false);
    ...
    settingToolClass::createActionForOption("Ignorer les erreurs réseau", "ignoreNetworkError", menuSetting, &respawnIrc, SLOT(setThisBoolOption(bool)));
    settingToolClass::createActionForOption("Beeper lors de la réception d'un message", "beepWhenWarn", menuSetting, &respawnIrc, SLOT(setThisBoolOption(bool)));
    settingToolClass::createActionForOption("Avertir visuellement lors de la réception d'un message", "warnUser", menuSetting, &respawnIrc, SLOT(setThisBoolOption(bool)));
    settingToolClass::createActionForOption("Avertir lors de l'édition d'un message", "warnWhenEdit", menuSetting, &respawnIrc, SLOT(setThisBoolOption(bool)));
    menuSetting->addSeparator();
